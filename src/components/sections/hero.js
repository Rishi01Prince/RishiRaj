...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Rishi Raj</h2>;
  ...
  const four = (
    <>
      ...
      <p>
        I am Rishi Raj, a tech enthusiast and LPU alumnus, currently innovating as a Software
        Development Engineer at Hummingbird Websolutions.
      </p>
  ...
  const five = (
    <a
      ...
      href="mailto:rishi.raj.3794@gmail.com"
      target="_blank"
      rel="noreferrer">
      Contact Me{' '}
